...
internal abstract class TrackingState
{
    ...
    protected TrackingState(IDatetimeProvider datetimeProvider, DateTime trackingStartedTime, int currentStopIndex, string busName)
    {

...
namespace STM.ExternalServiceProvider.Proto
{
    ...
    public static partial class GtfsRealtimeReflection
    {
        ...
        static GtfsRealtimeReflection()
        {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::STM.ExternalServiceProvider.Proto.EntitySelector), global::STM.ExternalServiceProvider.Proto.EntitySelector.Parser, new[]{ "AgencyId", "RouteId", "RouteType", "TransitTrip", "StopId" }, null, null, null, null),
...
#endif
    {
        ...
        /// <summary>
        /// The TransitTrip that this message applies to. There can be at most one
      ...
      if (trip_ != null) {
        output.WriteRawTag(10);
        output.WriteMessage(TransitTrip);
      }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 10: {
            if (trip_ == null) {
              TransitTrip = new global::TransitRealtime.TripDescriptor();
            }
            input.ReadMessage(TransitTrip);
            break;
          }
          case 18: {
...
#endif
    {
        ...
        private global::STM.ExternalServiceProvider.Proto.TripDescriptor trip_;
        /// <summary>
        /// The TransitTrip that this vehicle is serving.
...
#endif
    {
      ...
      while ((tag = input.ReadTag()) != 0) {
        ...
        public static partial class Types
        {
            ...
            {
                /// <summary>
                /// TransitTrip that is running in accordance with its GTFS schedule, or is close

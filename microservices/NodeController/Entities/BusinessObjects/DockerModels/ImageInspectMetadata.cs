...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class ImageInspectMetadata : IEquatable<ImageInspectMetadata>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ImageInspectMetadata)obj);
        }

        /// <summary>
        /// Returns true if ImageInspectMetadata instances are equal
        /// </summary>
        /// <param name="other">Instance of ImageInspectMetadata to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageInspectMetadata other)
        {
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (LastTagTime != null)
                    hashCode = hashCode * 59 + LastTagTime.GetHashCode();
                return hashCode;
            }
        }
        ...
        public static bool operator ==(ImageInspectMetadata left, ImageInspectMetadata right)
        {

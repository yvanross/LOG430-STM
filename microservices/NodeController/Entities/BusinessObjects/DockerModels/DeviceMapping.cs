...
{ 
    ...
    /// </summary>
    [DataContract]
    public partial class DeviceMapping : IEquatable<DeviceMapping>
    { 
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((DeviceMapping)obj);
        }

        /// <summary>
        /// Returns true if DeviceMapping instances are equal
        /// </summary>
        /// <param name="other">Instance of DeviceMapping to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeviceMapping other)
        {
            ...
            return 
                (
                    ...
                    PathOnHost != null &&
                    PathOnHost.Equals(other.PathOnHost)
                ) && 
                (
                    PathInContainer == other.PathInContainer ||
                    PathInContainer != null &&
                    PathInContainer.Equals(other.PathInContainer)
                ) && 
                (
                    CgroupPermissions == other.CgroupPermissions ||
                    CgroupPermissions != null &&
                    CgroupPermissions.Equals(other.CgroupPermissions)
                );
        }
        ...
        public static bool operator ==(DeviceMapping left, DeviceMapping right)
        {

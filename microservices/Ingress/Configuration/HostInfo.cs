...
public class HostInfo : IHostInfo
{
    ...
    private static readonly string NodeStateStorageToken = Environment.GetEnvironmentVariable("NODE_STATE_STORAGE_TOKEN")!;
    ...
    public string GetNodeStateStorageToken()
    {
        return NodeStateStorageToken;
    }
